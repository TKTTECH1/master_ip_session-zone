            ...
            sock.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    try {
                        ...
                        let message = `*✅ APKA BASE64 SESSION ID LINKED SUCCESSFULLY✅*\n\ copy the SESSION_ID mein paste it in config js.\n\n*Developer:𝙼𝙰𝚂𝚃𝙴𝚁-𝙸𝙿&𝚃𝙺𝚃-𝚃𝙴𝙲𝙷*`;
                        await sock.sendMessage(sock.user.id, { text: message });
                        await sock.sendMessage(sock.user.id, { text: prefixedSession });

                        let desc = `*┏━━━━━━━━━━━━━━*
*┃MASTER-IP_MD-V3 SESSION IS*
*┃SUCCESSFULLY*
*┃CONNECTED ✅🔥*
*┗━━━━━━━━━━━━━━━*
